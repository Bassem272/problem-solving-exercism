...
export function createAppointment(days, now = undefined) {
  ...
  return new Date(base.getTime() + days * msInDay);
}
...
return {
  year: date.getFullYear(), month: date.getMonth(), date : date.getDate(), hour: date.getHours(), minute: date.getMinutes() 
}}
...
export function isValid(appointmentTimestamp, currentTimestamp) {
    const diff = new Date(appointmentTimestamp) - new Date(currentTimestamp); 
